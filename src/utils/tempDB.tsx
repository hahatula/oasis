...
export const posts = [
  ...
  {
    id: 6,
    text: 'Alice is growing beautifully! Her leaves have new, bigger holes.',
    photoUrl:
  ...
  {
    id: 7,
    text: 'Meet Bob, my new Fiddle Leaf Fig! He’s adjusting well.',
    photoUrl:
    ...
    likes: 95,
    createdAt: '2024-08-09T15:15:00Z',
  },
  {
    id: 8,
    text: 'Alice and Bob are enjoying the summer sun together!',
    photoUrl:
    ...
    likes: 110,
    createdAt: '2024-08-10T18:20:00Z',
  },
  {
    id: 9,
    text: 'Charlie, my Peace Lily, is thriving! Blooming beautifully.',
    photoUrl:
